function [T_sys_dia_geometric] = calculate_T_sys_dia_geometric(PPGbeat,y,opt_params,algorithmName,freq)
% input:
...
T_sys_dia_geometric = T_dia - T_sys;
