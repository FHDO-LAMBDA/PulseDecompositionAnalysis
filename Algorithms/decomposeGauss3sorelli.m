function [signal_mod,y,opt_val_sort] = decomposeGauss3sorelli(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gauss3 algorithm (Sorelli restrictions)
%
% References:
...
%                 for derivation
%
% This function decomposes a single beat of a ppg signal by using 3 gaussian
...
% maxima location. The outputs are the 3 optimized basis functions, the 
% optimized parameters of the kernels as well as the reconstructed signal 
% which is the sum of the 3 basis functions.
%
% input: 
