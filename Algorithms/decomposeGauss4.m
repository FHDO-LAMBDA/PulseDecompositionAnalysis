function [signal_mod,y,opt_val_sort] = decomposeGauss4(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gauss4 algorithm (free positioning)
%
% References:
% -
%
% This function decomposes a single beat of a ppg signal by using 4
...
% respective maxima location. The outputs are the 4 optimized basis 
...
% combining the waves
g=@(x) gauss1(x)+gauss2(x)+gauss3(x)+gauss4(x);
