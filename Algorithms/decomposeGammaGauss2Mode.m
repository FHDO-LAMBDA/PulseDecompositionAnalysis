function [signal_mod,y,opt_val_sort] = decomposeGammaGauss2Mode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: GammaGauss2 algorithm (free positioning, 
%                               mode definition)
%
% References: 
...
% outputs are the 2 optimized basis functions, the optimized parameters of 
% the kernels as well as the reconstructed signal which is the sum of the 2
% basis functions.
% 
% input: 
