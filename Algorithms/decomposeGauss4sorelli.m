function [signal_mod,y,opt_val_sort] = decomposeGauss4sorelli(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gauss4 algorithm (Sorelli restrictions)
%
% References:
...
%                 for derivation
%
% This function decomposes a single beat of a ppg signal by using 4 gaussian
...
% maxima location. The outputs are the 4 optimized basis functions, the 
% optimized parameters of the kernels as well as the reconstructed signal 
% which is the sum of the 4 basis functions.
%
% input: 
