function [signal_mod,y,opt_val_sort] = decomposeGammaGauss2sorelliMode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: GammaGauss2 algorithm (Sorelli restrictions,
%                               mode definition)
%
% References: 
...
% function (defined by its mode) and 1 gaussian function as basis functions
...
% the 2 optimized basis functions, the optimized parameters of the kernels 
% as well as the reconstructed signal which is the sum of the 2 basis 
% functions.
% 
% input: 
