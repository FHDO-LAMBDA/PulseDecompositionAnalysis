function [signal_mod,y,opt_val_sort] = decomposeGammaGauss3Mode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: GammaGauss3 algorithm (free positioning, 
%                               mode definition)
%
% References: 
...
% function (defined by its mode) and 2 gaussian functions as basis functions
...
% outputs are the 3 optimized basis functions, the optimized parameters of 
% the kernels as well as the reconstructed signal which is the sum of the 3
% basis functions.
% 
% input: 
...
% combining the waves
g=@(x) gamma1(x)+gauss1(x)+gauss2(x);
