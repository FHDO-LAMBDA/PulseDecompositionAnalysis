function [signal_mod,y,opt_val_sort] = decomposeGammaGauss4sorelliMode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: GammaGauss4 algorithm (Sorelli restrictions,
%                               mode definition)
%
% References: 
...
% function (defined by its mode) and 3 gaussian function as basis functions
% with the restrictions of Sorelli et al. The optimization algorithm sorts 
% the basis functions by their respective maxima location. The outputs are 
% the 4 optimized basis functions, the optimized parameters of the kernels 
% as well as the reconstructed signal which is the sum of the 4 basis 
% functions.
% 
% input: 
