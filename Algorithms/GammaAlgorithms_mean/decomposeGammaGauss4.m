function [signal_mod,y,opt_val_sort] = decomposeGammaGauss4(ppg_signal,freq,varargin)
...
% function (defined by its mean) and 3 gaussian functions as basis functions
