function [signal_mod,y,opt_val_sort] = decomposeGamma4sorelli(ppg_signal,freq,varargin)
...
% functions (defined by their mean) as basis functions with the restrictions
