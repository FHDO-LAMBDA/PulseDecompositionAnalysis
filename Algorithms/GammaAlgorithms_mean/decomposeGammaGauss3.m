function [signal_mod,y,opt_val_sort] = decomposeGammaGauss3(ppg_signal,freq,varargin)
...
% function (defined by its mean) and 2 gaussian functions as basis functions
