function [signal_mod,y,opt_val_sort] = decomposeGamma4(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gamma4 algorithm (free positioning, mean
%                               definition)
%
% References: 
...
% functions (defined by their mean) as basis functions with empirically 
