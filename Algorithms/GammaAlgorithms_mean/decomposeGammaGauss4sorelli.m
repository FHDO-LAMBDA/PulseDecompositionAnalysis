function [signal_mod,y,opt_val_sort] = decomposeGammaGauss4sorelli(ppg_signal,freq,varargin)
...
% function (defined by its mean) and 3 gaussian function as basis functions
