function [signal_mod,y,opt_val_sort] = decomposeGammaGauss2sorelli(ppg_signal,freq,varargin)
...
% function (defined by its mean) and 1 gaussian function as basis functions
