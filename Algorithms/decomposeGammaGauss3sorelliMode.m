function [signal_mod,y,opt_val_sort] = decomposeGammaGauss3sorelliMode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: GammaGauss3 algorithm (Sorelli restrictions,
%                               mode definition)
%
% References: 
...
% function (defined by its mode) and 2 gaussian function as basis functions
...
% the 3 optimized basis functions, the optimized parameters of the kernels 
% as well as the reconstructed signal which is the sum of the 3 basis 
% functions.
% 
% input: 
