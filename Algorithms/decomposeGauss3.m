function [signal_mod,y,opt_val_sort] = decomposeGauss3(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gauss3 algorithm (free positioning)
%
% References:
% -
%
% This function decomposes a single beat of a ppg signal by using 3
...
% respective maxima location. The outputs are the 3 optimized basis 
...
% combining the waves
g=@(x) gauss1(x)+gauss2(x)+gauss3(x);
