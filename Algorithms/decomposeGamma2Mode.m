function [signal_mod,y,opt_val_sort] = decomposeGamma2Mode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gamma2 algorithm (free positioning, mode
%                               definition)
%
% References: 
...
%
% This function decomposes a single beat of a ppg signal by using 2 gamma
...
% functions by their respective maxima location. The outputs are the 2 
% optimized basis functions, the optimized parameters of the kernels as 
% well as the reconstructed signal which is the sum of the 2 basis 
% functions.
% 
% input: 
