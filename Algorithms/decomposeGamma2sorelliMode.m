function [signal_mod,y,opt_val_sort] = decomposeGamma2sorelliMode(ppg_signal,freq,varargin)
% Pulse Decomposition Analysis: Gamma2 algorithm (Sorelli restrictions,
%                               mode definition)
%
% References: 
...
% their respective maxima location. The outputs are the 2 optimized basis 
